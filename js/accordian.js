export function accordian(){
    ...
    accordianHead.forEach(accordianHead => {
        accordianHead.addEventListener('click', ()=>{
            const accordianHeadActive = document.querySelector('.accordian-item-head.active');
            ...
            if (accordianHeadActive && accordianHeadActive !== accordianHead){
                ...
                accordianHeadActive.lastElementChild.firstElementChild.style.transform = 'rotate(0deg)';
                accordianHeadActive.lastElementChild.lastElementChild.innerHTML = 'open';
            }
            ...
            if(accordianHead.classList.contains('active')){
                ...
                accordianHead.lastElementChild.firstElementChild.style.transform = 'rotate(180deg)';
                accordianHead.lastElementChild.lastElementChild.innerHTML = 'close';
            }
            else{
                accordianBody.style.maxHeight = 0;
                accordianHead.lastElementChild.firstElementChild.style.transform = 'rotate(0deg)';
                accordianHead.lastElementChild.lastElementChild.innerHTML = 'open';
            }
        });
    });
}
